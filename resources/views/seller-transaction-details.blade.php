                          ...
                          <div class="col-12 col-md-8">
                            <div class="row">
                              <div class="col-12 col-md-6">
                                <div class="product-title">Buyer Name</div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                    @if ($transactionsData->sellerpayout == 'request')
                                    <form action="/seller-transaction-detail/update/{{$transactionsData->transactionid}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                      <button
                                        type="submit"
